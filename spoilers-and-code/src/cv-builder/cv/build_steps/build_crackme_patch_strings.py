...
## Patches the string of a partial internal crackme binary.
#  Note: this binary is may be unusable in its output state - it may require further patching.
class BuildCrackmePatchString(BuildStep):
    ...
    def __call__(self) -> bool:
        process = self.elf_patcher(["protect-strings", self.input_path, self.output_path])
